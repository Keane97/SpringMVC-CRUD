...
//    }
    ...
    public Breweries(Integer id, String name, String address1, String address2, String city, String state, String code, String country, String phone, String website, String image, String description, int addUser, Date lastMod, double creditLimit, String email, float latitude, float longitude, int brewery_id) {
        this.id = id;
        this.name = name;
        this.address1 = address1;
        this.address2 = address2;
    ...
    public String toString() {
        return "Controllers.Breweries[ id=" + id + " ]";
    }
